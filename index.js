...
async function guessingNum() {
    while (play) {
        ...
        if (input.usernumber === randomNumber) {
            console.log(chalk.blackBright("congratulation, You guesse the correct number. "));
            console.log(chalk.greenBright(`You guess the actual number in ${100 - score} chances.`));
            play = false;
        }
            ...
            console.log(chalk.redBright("Your number is smaller then actual number."));
        }
    }
}
guessingNum();
